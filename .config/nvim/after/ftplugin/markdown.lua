...
local function get_relative_date(date_str)
  ...
  if diff_days == 0 then return "today"
  elseif diff_days == 1 then return "tomorrow"
  elseif diff_days == -1 then return "yesterday"
  elseif diff_days > 1 then return "in " .. diff_days .. " days"
  else return math.abs(diff_days) .. " days ago"
  end
end
